...
const SUBGRAPH_URL_BY_CHAIN: { [chainId in ChainId]?: string } = {
  ...
  //   'https://graph.stg.swap-redstone.w3us.site/subgraphs/name/swap-v3-redstone-garnet',
  // [ChainId.REDSTONE]: 
  //   'https://graph.stg.swap-redstone.w3us.site/subgraphs/name/swap-v3-redstone-mainnet',
};
